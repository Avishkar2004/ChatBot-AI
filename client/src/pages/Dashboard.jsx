    ...
    <Page>
      ...
      {/* Header */}
        ...
        <div className="hidden sm:flex gap-3">
            ...
            <a href="/projects" className="inline-flex items-center rounded-xl px-6 py-3 text-sm font-medium bg-white dark:bg-surface-elevated text-gray-900 dark:text-white border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200">Create Project</a>
          </div>
        </div>
      ...
      {/* Main panels */}
        ...
        <div className="lg:col-span-2 space-y-4">
            ...
            <div className="mt-4 grid sm:grid-cols-3 gap-3">
                ...
                <Link to="/projects" className="inline-flex items-center rounded-lg px-4 py-2 text-sm font-medium bg-white dark:bg-surface-elevated text-gray-900 dark:text-white border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200">Manage Prompts</Link>
                <Link to="/projects" className="inline-flex items-center rounded-lg px-4 py-2 text-sm font-medium bg-white dark:bg-surface-elevated text-gray-900 dark:text-white border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200">Open Chat</Link>
            </div>
          </div>
