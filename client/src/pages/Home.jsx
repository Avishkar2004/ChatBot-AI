...
function Home() {
    ...
    return (
      ...
      <Features />
            ...
            {!isAuthenticated && (
                <motion.section 
                    className="py-24 bg-gradient-to-r from-emerald-600 to-blue-600"
                    ...
                    <motion.Container>
                        ...
                        >
                            ...
                            >
                                <motion.a 
                                    href="/signup" 
                                    className="inline-flex items-center justify-center px-8 py-4 bg-white text-emerald-600 font-semibold rounded-xl shadow-lg"
                                    whileHover={{ 
                                        scale: 1.05,
                                        y: -2,
                                ...
                                <motion.a 
                                    href="/login" 
                                    className="inline-flex items-center justify-center px-8 py-4 bg-transparent text-white font-semibold rounded-xl border-2 border-white"
                                    whileHover={{ 
                                        scale: 1.05,
                                        y: -2,
