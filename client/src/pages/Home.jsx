          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              {!isAuthenticated && (
                ...
                >
                  {["No Credit Card Required", "Free Forever Plan"].map(
                    (text, index) => (
                      <motion.div
                        key={text}
          ...
          <motion.div className="relative">
            ...
            <Container>
              ...
              >
                ...
                >
                  Build Intelligent
                  <span className="bg-gradient-to-r from-green-900 to-emerald-800 bg-clip-text text-transparent">
                    {" "}
                    AI Agents
                  </span>
                </motion.h2>
                ...
                <motion.p
                  ...
                  transition={{ duration: 0.6, delay: 0.6 }}
                >
                  Create, customize, and deploy AI chatbots with advanced
                  conversational capabilities. Build the future of human-AI
                  interaction.
                </motion.p>
                <motion.div
