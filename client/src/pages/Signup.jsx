            ...
            <div className="bg-white dark:bg-surface-elevated rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-xl">
                      ...
                      {showPassword ? (
                        ...
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth="2"
                            d="M13.875 18.825A10.05 10.05 0 0112 19c-5 0-9-4-9-7 0-1.063.39-2.207 1.05-3.3M6.18 6.18C7.86 5.14 9.86 4.5 12 4.5c5 0 9 4 9 7 0 1.034-.375 2.145-1.02 3.22M3 3l18 18M9.88 9.88A3 3 0 1114.12 14.1"
                          />
                        </svg>
                      ) : (
                        <svg
                  ...
                  {password && (
                    <div className="mt-3 space-y-2">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs text-gray-500 dark:text-gray-400">
                        <div
                          className={`flex items-center gap-1.5 ${password.length >= 8 ? "text-emerald-600 dark:text-emerald-400" : ""}`}
                        >
                          <svg
                            className={`w-4 h-4 ${password.length >= 8 ? "" : "opacity-30"}`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                        ...
                        <div
                          className={`flex items-center gap-1.5 ${/[A-Z]/.test(password) ? "text-emerald-600 dark:text-emerald-400" : ""}`}
                        >
                          <svg
                            className={`w-4 h-4 ${/[A-Z]/.test(password) ? "" : "opacity-30"}`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                        ...
                        <div
                          className={`flex items-center gap-1.5 ${/[0-9]/.test(password) ? "text-emerald-600 dark:text-emerald-400" : ""}`}
                        >
                          <svg
                            className={`w-4 h-4 ${/[0-9]/.test(password) ? "" : "opacity-30"}`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                        ...
                        <div
                          className={`flex items-center gap-1.5 ${/[^a-zA-Z0-9]/.test(password) ? "text-emerald-600 dark:text-emerald-400" : ""}`}
                        >
                          <svg
                            className={`w-4 h-4 ${/[^a-zA-Z0-9]/.test(password) ? "" : "opacity-30"}`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <p className="text-sm text-center text-gray-600 dark:text-gray-400">
                  ...
                  <Link
                    to="/login"
                    className="font-medium text-emerald-600 dark:text-emerald-400 hover:opacity-80 transition"
                  >
                    Log in
                  </Link>
                </p>
